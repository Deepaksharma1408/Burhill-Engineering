      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="bg-slate-bg border border-slate-border rounded-lg p-6 space-y-4 font-mono text-xs text-navy">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-gold mt-1">COORDINATES: {SITE_CONTENT.officeDetails.coordinates}</div>
                </div>
              </div>
              ...
              <div className="pt-3 border-t border-slate-border flex items-center space-x-3">
                ...
                <div>
                  ...
                  <a href={`tel:${SITE_CONTENT.company.phone.replace(/[^0-9+]/g, '')}`} className="font-bold hover:text-gold">
              ...
              <div className="pt-3 border-t border-slate-border flex items-center space-x-3">
                ...
                <div>
                  ...
                  <a href={`mailto:${SITE_CONTENT.company.email}`} className="font-bold hover:text-gold">
            ...
            <div className="bg-navy-dark border border-navy-border rounded-lg p-6 relative overflow-hidden space-y-4">
              <TechnicalGridOverlay dark />
          ...
          <div className="lg:col-span-7 bg-white border border-slate-border rounded-xl p-8 shadow-lg space-y-6">
            ...
            {submitted ? (
              <div className="bg-navy-dark text-white p-8 rounded-lg border border-gold/50 space-y-4 text-center">
                ...
                <button
                  ...
                  className="text-xs font-mono text-gold hover:underline pt-2 block mx-auto"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {/* Note for Backend Developer in HTML/Code */}
                {/* NOTE: Spam protection (reCAPTCHA/Turnstile) and form submission logic to be added in backend phase */}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 rounded border border-slate-border bg-slate-bg text-slate-800 text-sm focus:outline-none focus:border-navy focus:bg-white"
                    />
                  </div>
                ...
                <div className="pt-2 flex items-center justify-between">
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center space-x-2 bg-gold hover:bg-gold-light text-navy-dark font-sans text-xs font-bold px-6 py-3 rounded shadow transition-all transform hover:-translate-y-0.5"
                  >
