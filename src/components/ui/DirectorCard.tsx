...
export const DirectorCard: React.FC<DirectorCardProps> = ({ director }) => {
  return (
    <div className="bg-white border border-slate-border rounded-lg overflow-hidden flex flex-col justify-between hover:border-gold hover:shadow-xl transition-all duration-300">
      {/* Top Banner & Photo Placeholder */}
      <div className="bg-navy-dark p-6 text-white relative border-b border-navy-border">
        <div className="flex items-start justify-between">
          ...
          <div className="w-16 h-16 rounded border-2 border-gold bg-navy flex items-center justify-center text-gold font-serif text-2xl font-bold shadow-inner">
      ...
      <div className="p-6 space-y-4 flex-1">
        <div className="flex items-center space-x-2 text-xs font-mono text-navy bg-slate-bg px-3 py-1.5 rounded border border-slate-border w-fit">
      ...
      {/* Footer stamp */}
      <div className="px-6 py-3 bg-slate-bg border-t border-slate-border flex items-center justify-between text-[10px] font-mono text-slate-500">
